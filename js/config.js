...
(function () {
  ...
  const ENEMIES = {
    ...
    sniper: { name: "狙击手", hp: 22, speed: 60, dmg: 6, projDmg: 11, xp: 6, r: 12, color: "#ff8aff", ai: "sniper", shape: "diamond", pattern: "sight", skill: "远程站桩,精确狙击(接触伤害较低)" },
    regen: { name: "自愈者", hp: 48, speed: 56, dmg: 14, xp: 6, r: 16, color: "#5affb0", ai: "regen", regenRate: 7, shape: "cross", pattern: "plus", skill: "持续回血" },
    warden: { name: "光环盾卫", hp: 60, speed: 48, dmg: 14, xp: 8, r: 19, color: "#8aa0ff", ai: "shield_aura", shape: "hex", pattern: "double_hex", auraR: 140, auraDr: 0.40, skill: "给周围敌人套减伤护盾(减伤随时间提升,上限70%)" },
