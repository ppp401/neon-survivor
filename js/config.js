...
(function () {
  ...
  const BOSSES = {
    duke: { name: "肥胖公爵", icon: "☠", hp: 850, speed: 35, dmg: 25, attacks: { projectile: [10] }, r: 40, color: "#d65a8a", xp: 60, tier: 1, shape: "hex", pattern: "crown", shotStyle: "ring", skill: "召唤僵尸 + 环形弹幕" },
    ...
    scavenger: { name: "拾荒机兵", icon: "⚙", hp: 760, speed: 62, dmg: 21, attacks: { projectile: [10] }, mechanics: { warn: 0.9, chargeSpeed: 250 }, r: 35, color: "#f1ad62", xp: 55, tier: 1, shape: "square", pattern: "nodes", shotStyle: "bolt", skill: "追击 + 预警冲刺" },
    frostwarden: { name: "霜壳守卫", icon: "❄", hp: 900, speed: 38, dmg: 22, attacks: { projectile: [9] }, mechanics: { warn: 0.7, follow: 0.5, interval: 3.8, flankAngle: 0.34, flankSpeed: 155, centerSpeed: 170 }, r: 39, color: "#8ddfff", xp: 65, tier: 1, shape: "hex", pattern: "double_hex", shotStyle: "rune", skill: "锁定方位，先射两侧冰弹，再补中路冰弹" },
    bloodhunter: { name: "血棘猎手", icon: "✦", hp: 780, speed: 62, dmg: 20, attacks: { projectile: [9] }, mechanics: { range: 245, swayRate: 3, swayAngle: 0.38, warn: 0.75, interval: 4.0, flankDist: 58, spread: 0.16, shotSpeed: 185 }, r: 32, color: "#ff5278", xp: 60, tier: 1, shape: "triangle", pattern: "bloodthorn", shotStyle: "bolt", skill: "锁定玩家位置，从两侧发射交汇棘弹" },
    riftsentry: { name: "裂隙哨兵", icon: "◇", hp: 860, speed: 40, dmg: 22, attacks: { projectile: [8, 9] }, mechanics: { warn: 0.8, interval: 4.7, portalDist: 75, spread: 0.22, shotSpeed: 160 }, r: 38, color: "#a58bff", xp: 65, tier: 1, shape: "diamond", pattern: "rift", shotStyle: "rune", skill: "从成对裂隙向锁定位置交叉射击" },
    thornwarden: { name: "铁棘卫士", icon: "✥", hp: 870, speed: 43, dmg: 22, attacks: { projectile: [9] }, mechanics: { warn: 0.8, recovery: 0.9, interval: 4.0, armor: 0.25, spread: 0.38, shotSpeed: 190 }, r: 37, color: "#c47a9b", xp: 65, tier: 1, shape: "hex", pattern: "shield", shotStyle: "bolt", skill: "展开护甲后发射扇形弹幕，射后短暂硬直" },
