...
(function () {
  ...
  const EN = {
    ...
    bosses: {
      ...
      scavenger:["Scavenger Automaton","Pursues and telegraphs short charges"], frostwarden:["Frost Warden","Locks a direction, firing side frost bolts before a delayed center bolt"], bloodhunter:["Bloodthorn Hunter","Marks your position, then fires converging thorn bolts from both flanks"], riftsentry:["Rift Sentry","Opens paired rifts and crossfires from both sides"], thornwarden:["Ironthorn Warden","Armors up to charge a fan volley, then briefly recovers"], stormherald:["Storm Herald","Sidesteps and sweeps electric bolts through an arc"], bloodoracle:["Blood Oracle","Summons ritual followers that fire while they survive"], furnace:["Furnace Core","Warned burn zones and fiery spiral barrages"], voidseer:["Void Seer","Marks a teleport destination; its old position fires a delayed cross barrage"], eclipseeye:["Eclipse Eye","Orbits and charges two pulse rings with a safe gap"]
    },
