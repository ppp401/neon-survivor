...
(function () {
  ...
  const EN = {
    ...
    bosses: {
      duke:["Bloated Duke","Summons Rotwalkers + radial barrages"], wraith:["Twin Wraiths","Orbit + fan barrages; survivor enrages and releases radial barrages"], queen:["Brood Queen","Summons swarms + radial/spiral barrages"], magnetwarper:["Magnet Warper","Gravity waves pull the player inward + release barrages + close-range shocks"], twins:["Mirror Twins","Pursue and swap; killing one damages and enrages the other"], architect:["The Architect","Radial barrages + summoned firing turrets"], inquisitor:["Inquisitor","Close teleports + radial/fan volleys"], colossus:["Bullet Colossus","Stationary rotating lasers + summons + spiral barrages"],
      scavenger:["Scavenger Automaton","Telegraphed charges followed by a high-speed fan volley"], frostwarden:["Frost Warden","Locks a direction, firing side frost bolts before a delayed center bolt"], bloodhunter:["Bloodthorn Hunter","Marks your position, then fires converging thorn bolts from both flanks"], riftsentry:["Rift Sentry","Opens paired rifts and crossfires from both sides"], thornwarden:["Ironthorn Warden","Armors up to charge a fan volley, then briefly recovers"], stormherald:["Storm Herald","Sidesteps and sweeps electric bolts through an arc"], bloodoracle:["Blood Oracle","Summons ritual followers that fire while they survive"], furnace:["Furnace Core","Twin warned burn zones + fiery spiral barrages"], voidseer:["Void Seer","Marks a teleport destination and crossfires from its old and new positions"], eclipseeye:["Eclipse Eye","Orbits with aimed volleys + two pulse rings with a safe gap"]
    },
