...
(function () {
  ...
  const EN = {
    ...
    characters: {
      ...
      overclocker:["Overclocker","Overload Core","HP ×0.9; periodically enters a high-output, high-risk overload.",["Every 8s for 2.5s","Weapon damage ×1.1, attack frequency ×1.35, damage taken ×1.25","Affects cooldowns, auras, turrets, continuous hits, and fusions; not DoT or control"]],
